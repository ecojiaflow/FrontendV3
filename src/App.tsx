...
import DetergentDemo from './pages/DetergentDemo';        // 👉 NEW
       ...
       <div className="min-h-screen bg-gray-50">
         ...
         <main>
           <Routes>
             ...
             <Route path="/detergent-demo" element={<DetergentDemo />} /> {/* NEW */}
         ...
         <footer className="bg-white border-t border-gray-200 mt-12">
           <div className="max-w-6xl mx-auto px-4 py-8">
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <div>
                 ...
                 <p className="text-gray-600 text-sm">
                   Intelligence Artificielle pour une consommation responsable
                   et éclairée multi-catégories.
                 </p>
               </div>
               ...
               <div>
                 ...
                 <ul className="space-y-2 text-sm text-gray-600">
                   ...
                   <li>💄 Analyse cosmétiques INCI</li>
                   <li>🧽 Impact environnemental détergents</li>
             ...
             <div className="border-t border-gray-200 mt-8 pt-6 text-center">
               <p className="text-gray-600 text-sm">
                 © 2025 ECOLOJIA • Révolution de la consommation responsable multi-catégories
               </p>
             </div>
           </div>
         </footer>
